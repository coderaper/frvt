...
bin/$provider_frvt_driver_name enroll -c $configDir -o $outputDir -h $outputStem -i $inputFile -t $numForks
retEnrollment=$?
...
# Finalization
bin/$provider_frvt_driver_name finalize -c $configDir -e $enrollDir -o $outputDir -h $outputStem
retFinalize=$?
...
bin/$provider_frvt_driver_name search -c $configDir -e $enrollDir -o $outputDir -h $outputStem -i $inputFile -t $numForks
retSearch=$?
...
bin/$provider_frvt_driver_name insertAndDelete -c $configDir -e $enrollDir -o $outputDir -h $outputStem -i $inputFile -t $numForks
retInsertAndDelete=$?
